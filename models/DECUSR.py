...
from tensorflow.keras.layers import Input,  ZeroPadding2D,  LocallyConnected2D, Conv2DTranspose, concatenate, BatchNormalization
...
def build_model(self, testmode=False):
    ...
    # print("\nKERNEL: ", self.kernel_initializer, "\n")
